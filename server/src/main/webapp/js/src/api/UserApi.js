  ...
  self.createUser = function(body, callback) {
    ...
    var postBinaryBody = null;
     ...
     if (body == null) {
        ...
        var errorRequiredMsg = "Missing the required parameter 'body' when calling createUser";
  ...
  self.createUsersWithArrayInput = function(body, callback) {
    ...
    var postBinaryBody = null;
     ...
     if (body == null) {
        ...
        var errorRequiredMsg = "Missing the required parameter 'body' when calling createUsersWithArrayInput";
        throw errorRequiredMsg;
     }
  ...
  self.createUsersWithListInput = function(body, callback) {
    ...
    var postBinaryBody = null;
     ...
     if (body == null) {
        ...
        var errorRequiredMsg = "Missing the required parameter 'body' when calling createUsersWithListInput";
        throw errorRequiredMsg;
     }
  ...
  self.loginUser = function(username, password, callback) {
    ...
    var postBinaryBody = null;
     ...
     if (username == null) {
        ...
        var errorRequiredMsg = "Missing the required parameter 'username' when calling loginUser";
        throw errorRequiredMsg;
     }
     ...
     if (password == null) {
        ...
        var errorRequiredMsg = "Missing the required parameter 'password' when calling loginUser";
        throw errorRequiredMsg;
     }
  ...
  self.updateUser = function(username, body, callback) {
    ...
    var postBinaryBody = null;
     ...
     if (body == null) {
        ...
        var errorRequiredMsg = "Missing the required parameter 'body' when calling updateUser";
        throw errorRequiredMsg;
     }
